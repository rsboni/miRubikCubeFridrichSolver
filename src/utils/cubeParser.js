...
const converseAngleSetXfirst = (cube, angle, angleFace, f1, f2, f3) => {
  let num = 0
  if (angle === 1) {
...
const converseAngleSetYfirst = (cube, angle, angleFace, f1, f2, f3) => {
  let num = 0
  if (angle === 1) {
...
const converseLineSetSingle = (cube, lineFace, p1, p2, c1, c2) => {
  let result = 0
  if (lineFace === 1) {
    cube[p1] = c1
    cube[p2] = c2
...
const converseLineSet = (cube, line, lineFace, p1, p2) => {
  let num = 0
  if (line === 1) {
...
const converseChangeFaceAgain = (cube, a1, a2, a3, a4) => {
  const num = cube[a4]
  cube[a4] = cube[a3]
  cube[a3] = cube[a2]
  cube[a2] = cube[a1]
